...
<script src="${pageContext.request.contextPath}/asset/css/temp/lib/waypoints/waypoints.min.js"></script>
<script src="${pageContext.request.contextPath}/asset/css/temp/lib/owlcarousel/owl.carousel.min.js"></script>
<script src="${pageContext.request.contextPath}/asset/css/temp/lib/tempusdominus/js/moment.min.js"></script>
<script src="${pageContext.request.contextPath}/asset/css/temp/lib/tempusdominus/js/moment-timezone.min.js"></script>
<script src="${pageContext.request.contextPath}/asset/css/temp/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>
