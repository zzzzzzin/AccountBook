...
카드 사용금액 조회를 통해 사용자는 카드별로 어떤 부문에서 얼마나 지출되었는지를 알 수 있습니다.</li>
    	...
    	<blockquote class="page-description">
            ...
            <strong>우리의 가계부 웹사이트는 사용자들이 자신의 소비 습관을 파악하고 최적의 신용카드를 선택할 수 있도록 도와줍니다.</strong>
            <br><br>
            <p>
                &nbsp;이를 위해 소비자 맞춤 카드 추천 기능을 제공합니다. 이 기능은 사용자가 자주 이용하는 소비 부문을 기반으로, 해당 부문에서 가장 적합한 혜택을 제공하는 카드를 추천해줍니다.
            </p>
			            
            <strong>소비자 맞춤 카드 추천의 원리</strong><br>
            <ol style="padding-left: 0">
                <li><strong>1. 소비 부문 분석 </strong>
                <br>&nbsp;사용자의 가계부 데이터를 분석하여 어떤 부문에서 가장 많은 소비가 이루어졌는지 확인합니다. 예를 들어, 식료품, 교통, 의류 등의 다양한 부문을 고려합니다.</li><br>
                <li><strong>2. 카드 혜택 분석 </strong>
                <br>&nbsp; 다양한 카드의 혜택을 수집하고 분석합니다. 이는 카드 회사의 웹사이트, 프로모션 정보, 리워드 프로그램 등을 통해 이루어집니다. 각 카드의 혜택은 해당 부문에서 제공되는 할인율, 적립률, 현금 환급 등을 포함합니다.</li></br>
                <li><strong>3. 맞춤 카드 추천 </strong>
                <br>&nbsp;사용자의 소비 부문과 카드의 혜택을 고려하여 가장 적합한 카드를 추천합니다. 이를 위해 알고리즘은 사용자의 소비 패턴과 카드의 혜택을 비교하여 최적의 조합을 찾습니다. 예를 들어, 식료품을 가장 많이 소비하는 사용자에게는 해당 부문에서 할인 혜택이 뛰어난 카드를 추천할 수 있습니다.</li><br>
            </ol>
		</blockquote>
	   	<blockquote class="page-description">
            <h4><a href="/account/board/view.do"><i class="fas fa-clipboard"></i> 게시판</a></h4> 
            <strong>다양한 게시판을 통해 회원들은 서로 소통하고 정보를 공유할 수 있습니다.</strong><br>
								<br><ol style="padding-left: 0">
									<li><strong>1. 공지사항 </strong> 
									<br>&nbsp;&nbsp;관리자가 회원들에게 중요한 정보나
										업데이트 사항을 알리는 공간입니다. 회원들이 반드시 알아야 할 사항이나 서비스의 변경사항 등을 여기에 올립니다.</li>
									<br><li><strong>2. 건의사항 </strong> 
									<br>&nbsp;&nbsp;회원들이 서비스에 대한 건의나 개선
										사항을 제안하는 공간입니다. 이 게시판을 통해 회원들은 자신들의 의견을 나누고 서비스 향상을 위한 제안을 할 수
										있습니다.</li>
									<br><li><strong>3. 자유게시판 </strong> 
									<br>&nbsp;&nbsp;회원들이 자유롭게 의견을 나누고
										정보를 공유하는 공간입니다. 특정 주제나 제한된 내용 없이 다양한 주제에 대해 이야기할 수 있습니다.</li>
									<br><li><strong>4. 출석게시판 </strong> 
									<br>회원들이 매일 출석체크를 하고
										&nbsp;&nbsp;출석 현황을 확인하는 공간입니다. 이를 통해 회원들끼리 활동 상태를 공유하고 꾸준한 참여를 유도합니다.</li>
								</ol>
