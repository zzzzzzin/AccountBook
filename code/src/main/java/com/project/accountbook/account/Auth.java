 ...
 * throws IOException {
 * 
 * HttpSession session = req.getSession(); String seq = req.getParameter("seq");
 * // Edit.java의 req를 받았기 때문에 seq를 받을 수 있다.
 * 
 * // 글쓴이 본인? BoardDAO dao = new BoardDAO();
 * 
 * BoardDTO dto = dao.get(seq);
 * 
 * // id != dto.id && lv != 2 if (session.getAttribute("id") == null ||
 ...
 * writer.print(OutputUtil.redirect("권한이 없습니다.")); writer.close();
 * 
 * return true; }
 * 
 * return false; }
