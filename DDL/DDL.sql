...
CREATE TABLE "tblMember" (
	...
	"seq"           NUMBER       NOT NULL, -- 설문조사 번호
	"seqProfileimg" NUMBER       NOT NULL  -- 프로필 이미지 번호
);

-- 회원 기본키
CREATE UNIQUE INDEX "PK_tblMember"
	ON "tblMember" ( -- 회원
		"id" ASC -- 아이디(이메일)
	);
...
-- 설문조사 기본키
CREATE UNIQUE INDEX "PK_tblSurvey"
	ON "tblSurvey" ( -- 설문조사
		"seq" ASC -- 번호
	);
...
-- 프로필 이미지 기본키
CREATE UNIQUE INDEX "PK_tblProfileimg"
	ON "tblProfileimg" ( -- 프로필 이미지
		"seq" ASC -- 번호
	);
...
-- 게시판 카테고리 기본키
CREATE UNIQUE INDEX "PK_tblCategory"
	ON "tblCategory" ( -- 게시판 카테고리
		"seq" ASC -- 번호
	);
...
-- 게시판 기본키
CREATE UNIQUE INDEX "PK_tblBoard"
	ON "tblBoard" ( -- 게시판
		"seq" ASC -- 번호
	);
...
-- 게시글 기본키
CREATE UNIQUE INDEX "PK_tblPost"
	ON "tblPost" ( -- 게시글
		"seq" ASC -- 번호
	);
...
-- 댓글 기본키
CREATE UNIQUE INDEX "PK_tblComments"
	ON "tblComments" ( -- 댓글
		"seq" ASC -- 번호
	);
...
-- 가계부 카테고리 기본키
CREATE UNIQUE INDEX "PK_tblAccCategory"
	ON "tblAccCategory" ( -- 가계부 카테고리
		"seq" ASC -- 번호
	);
...
-- 대댓글 기본키
CREATE UNIQUE INDEX "PK_tblReplyComments"
	ON "tblReplyComments" ( -- 대댓글
		"seq" ASC -- 번호
	);
...
-- 권한 기본키
CREATE UNIQUE INDEX "PK_tblPriv"
	ON "tblPriv" ( -- 권한
		"seq" ASC -- 번호
	);
...
-- 첨부 파일 기본키
CREATE UNIQUE INDEX "PK_tblAttachedFile"
	ON "tblAttachedFile" ( -- 첨부 파일
		"seq" ASC -- 번호
	);
...
-- 가계부 내용 기본키
CREATE UNIQUE INDEX "PK_tblAccInfo"
	ON "tblAccInfo" ( -- 가계부 내용
		"seq" ASC -- 번호
	);
...
-- 키워드 기본키
CREATE UNIQUE INDEX "PK_tblKeyword"
	ON "tblKeyword" ( -- 키워드
		"seq" ASC -- 번호
	);
...
-- 가계부 카테고리 목록 기본키
CREATE UNIQUE INDEX "PK_tblAccCategoryList"
	ON "tblAccCategoryList" ( -- 가계부 카테고리 목록
		"seq" ASC -- 번호
	);
...
-- 구매 위시 목록 기본키
CREATE UNIQUE INDEX "PK_tblPurchaseWishList"
	ON "tblPurchaseWishList" ( -- 구매 위시 목록
		"seq" ASC -- 번호
	);
...
-- 카드 정보 기본키
CREATE UNIQUE INDEX "PK_tblCardInformation"
	ON "tblCardInformation" ( -- 카드 정보
		"seq" ASC -- 번호
	);
...
-- 카드 카테고리 기본키
CREATE UNIQUE INDEX "PK_tblCardCategory"
	ON "tblCardCategory" ( -- 카드 카테고리
		"seq" ASC -- 번호
	);
...
-- 카드/가계부 카테고리 연결 기본키
CREATE UNIQUE INDEX "PK_tblCardAndAcc"
	ON "tblCardAndAcc" ( -- 카드/가계부 카테고리 연결
		"seq" ASC -- 번호
	);
...
-- 카드 혜택 목록 기본키
CREATE UNIQUE INDEX "PK_tblListCardBenefits"
	ON "tblListCardBenefits" ( -- 카드 혜택 목록
		"seq" ASC -- 번호
	);
...
-- 배너 이미지 기본키
CREATE UNIQUE INDEX "PK_tblBannerImage"
	ON "tblBannerImage" ( -- 배너 이미지
		"seq" ASC -- 번호
	);
...
-- 뉴스 기본키
CREATE UNIQUE INDEX "PK_tblNews"
	ON "tblNews" ( -- 뉴스
		"seq" ASC -- 번호
	);
...
-- 금지어 기본키
CREATE UNIQUE INDEX "PK_tblBanWord"
	ON "tblBanWord" ( -- 금지어
		"seq" ASC -- 번호
	);
...
-- 회원 권한 목록 기본키
CREATE UNIQUE INDEX "PK_tblMemberPriv"
	ON "tblMemberPriv" ( -- 회원 권한 목록
		"seq" ASC -- 번호
	);
...
-- 관리자 권한 목록 기본키
CREATE UNIQUE INDEX "PK_tblAdminPriv"
	ON "tblAdminPriv" ( -- 관리자 권한 목록
		"seq" ASC -- 번호
	);
...
-- 사용자 기본키
CREATE UNIQUE INDEX "PK_tblUser "
	ON "tblUser " ( -- 사용자
		"seq" ASC -- 번호
	);
...
-- 압박 강도 기본키
CREATE UNIQUE INDEX "PK_tblCompressionIntensity"
	ON "tblCompressionIntensity" ( -- 압박 강도
		"seq" ASC -- 번호
	);
...
-- 나의 카드 기본키
CREATE UNIQUE INDEX "PK_tblMyCard"
	ON "tblMyCard" ( -- 나의 카드
		"seq" ASC -- 번호
	);
...
-- 카드 타입 기본키
CREATE UNIQUE INDEX "PK_tblCardType"
	ON "tblCardType" ( -- 카드 타입
		"seq" ASC -- 번호
	);
...
-- 변동 사유 카테고리 기본키
CREATE UNIQUE INDEX "PK_tblReasonChangeCategory"
	ON "tblReasonChangeCategory" ( -- 변동 사유 카테고리
		"seq" ASC -- 번호
	);
...
-- 고정 변동 기간 기본키2
CREATE UNIQUE INDEX "PK_tblFixedFluctuationPeriod"
	ON "tblFixedFluctuationPeriod" ( -- 고정 변동 기간
		"seq" ASC -- 번호
	);
...
-- 고정 입출금 여부 기본키
CREATE UNIQUE INDEX "PK_tblFixedDepositWithdrawalCheck"
	ON "tblFixedDepositWithdrawalCheck" ( -- 고정 입출금 여부
		"seq" ASC -- 번호
	);
...
-- 입출금 상태 기본키
CREATE UNIQUE INDEX "PK_tblDepositWithdrawalStatus"
	ON "tblDepositWithdrawalStatus" ( -- 입출금 상태
		"seq" ASC -- 번호
	);
...
-- 자산 기본키
CREATE UNIQUE INDEX "PK_tblProperty"
	ON "tblProperty" ( -- 자산
		"seq" ASC -- 번호
	);
...
-- 부채 기본키
CREATE UNIQUE INDEX "PK_tblDebt"
	ON "tblDebt" ( -- 부채
		"seq" ASC -- 번호
	);
...
-- 회원 금융 정보 기본키
CREATE UNIQUE INDEX "PK_tblMemberFinance"
	ON "tblMemberFinance" ( -- 회원 금융 정보
		"seq" ASC -- 번호
	);
...
-- 변동 사유 목록 기본키
CREATE UNIQUE INDEX "PK_tblReasonsChangeList"
	ON "tblReasonsChangeList" ( -- 변동 사유 목록
		"seq" ASC -- 번호
	);
...
-- 뉴스 카테고리 목록 기본키
CREATE UNIQUE INDEX "PK_tblNewsCategoryList"
	ON "tblNewsCategoryList" ( -- 뉴스 카테고리 목록
		"seq" ASC -- 번호
	);
...
CREATE TABLE "tblSavingsPeriod" (
	"seq"    NUMBER  NOT NULL, -- 번호
	"period" NUMMBER NOT NULL  -- 기간
);

-- 저축 기간 기본키
CREATE UNIQUE INDEX "PK_tblSavingsPeriod"
	ON "tblSavingsPeriod" ( -- 저축 기간
		"seq" ASC -- 번호
	);
...
ALTER TABLE "tblPost"
	ADD
		CONSTRAINT "FK_tblUser _TO_tblPost" -- 사용자 -> 게시글
		FOREIGN KEY (
			"seqUser" -- 사용자 번호
		)
...
ALTER TABLE "tblComments"
	ADD
		CONSTRAINT "FK_tblUser _TO_tblComments" -- 사용자 -> 댓글
		FOREIGN KEY (
			"seqUser " -- 사용자 번호
		)
		REFERENCES "tblUser " ( -- 사용자
...
ALTER TABLE "tblReplyComments"
	ADD
		CONSTRAINT "FK_tblUser _TO_tblReplyComments" -- 사용자 -> 대댓글
		FOREIGN KEY (
			"seqUser " -- 사용자 번호
		)
		REFERENCES "tblUser " ( -- 사용자
...
ALTER TABLE "tblPurchaseWishList"
	ADD
		CONSTRAINT "FK_tblUser _TO_tblPurchaseWishList" -- 사용자 -> 구매 위시 목록
		FOREIGN KEY (
			"seqUser " -- 사용자 번호
		)
		REFERENCES "tblUser " ( -- 사용자
